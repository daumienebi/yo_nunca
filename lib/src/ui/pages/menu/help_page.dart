    ...
    return ListView(
      children: [
        ...
        _HelpListTile(
            ...
            onTap: () {
              final url =
                  Uri.parse('https://daumienebi.github.io/yo_nunca/help/');
              _launchUrl(url);
            }),
         */
        _HelpListTile(
          ...
          onTap: () {
            ...
            final url =
                Uri.parse('https://daumienebi.github.io/yo_nunca/policy.html');
            _launchUrl(url);
          },
        ),
        _HelpListTile(
          ...
          onTap: () async {
            final url = Uri.parse(
                'https://daumienebi.github.io/yo_nunca/terms_and_conditions.html');
            _launchUrl(url);
          },
        ),
        _HelpListTile(
...
class _HelpListTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final titleStyle = TextStyle(
        fontSize: 16, color: dangerZone ? Colors.red : Colors.black87);
