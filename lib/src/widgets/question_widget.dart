...
*/
  ...
  Widget build(BuildContext context) {
    ...
    return Center(
      child: FutureBuilder(
        ...
        List<Widget> test = [];
        if(snapshot.hasData){
          test = snapshot.data != null && snapshot.data.length > 0 ? _questionWidget(snapshot) : _noQuestionWidget();
  ...
  _questionWidget(AsyncSnapshot snapshot){
  ...
  _noQuestionWidget(){
    ...
    //no questions
    String errorMessage = 'No hay preguntas para esta categoría, ve a las categorias para añadirlas.';
    return <Widget>[
      Container(
        height: 250,
        width: 300,
